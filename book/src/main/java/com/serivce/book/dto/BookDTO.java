...
public class BookDTO {
	...
	public String toString() {
		return "BookDTO [bookId=" + bookId + ", isbn=" + isbn + ", categoryDTO=" + categoryDTO + ", publishingHouseDTO="
				+ publishingHouseDTO + ", authors=" + authors + ", title=" + title + ", publishedDate=" + publishedDate
